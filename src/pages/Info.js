            ...
            <div className="sectionDiv">
                <Container>
                    ...
                    <Card style={{ border: "none" }}>
                        ...
                        <h4>Adriana Lippy</h4>
                        <Image src={Adrianna} style={{ height: "50%", width: "50%", margin: "auto" }} className="mt-2 mb-2"></Image>
                        ...
                        <h4>Cass Sauve</h4>
                        <Image src={Cass} style={{ height: "50%", width: "50%", margin: "auto" }} className="mt-2 mb-2"></Image>
                        ...
                        <h4>Mattie Olson</h4>
                        <Image src={Mattie} style={{ height: "50%", width: "50%", margin: "auto" }} className="mt-2 mb-2"></Image>
                        ...
                        <h4>Brian Cobb </h4>
                        <Image src={Brian} style={{ height: "50%", width: "50%", margin: "auto" }} className="mt-2 mb-2"></Image>
                        ...
                        <h4>Frank Coletta</h4>
                        <Image src={Frank} style={{ height: "50%", width: "50%", margin: "auto" }} className="mt-2 mb-2"></Image>
                        ...
                        <h4>Pat Abts</h4>
                        <Image src={Pat} style={{ height: "50%", width: "50%", margin: "auto" }} className="mt-2 mb-2"></Image>
